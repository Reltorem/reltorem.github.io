...
- Stylus (must be compatible)

- Hands-free Headset (USB wired, 3.5mm analog jack [Tip Ring Ring Sleeve TRRS], Bluetooth, USB Dongle)
...
Antennaes cover an area in cells.
...
3G Mobile internet (1998)

4G True broadband speeds. (LTE - Long Term Evolution).
Based on GSM (Global System for Mobile Communications) / EDGE (Enhanced Data Rates for GSM Evolution)
...
Has small amount of storage for contacts, messages. etc.

Some new phones have an embedded eSIM which is non-removable.
